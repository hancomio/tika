...
public class TFChmExtractor {
    ...
    public TFChmExtractor(InputStream is) throws TikaException, IOException {
...
//                    if (i == getLzxBlocksCache().size() && i == 0) {
        	...
        	// 일부 추출되는 파일들을 위해서 로그만 출력.. 하고 싶지만..
        	// 너무 에러로그가 많이 출력되는 관계로 아쉽지만 로그도 제거.
