 ...
 */
public class TFLyricsHandler {
    boolean foundLyrics = false;
    String lyricsText = null;
    TFID3v1Handler id3v1 = null;

    public TFLyricsHandler(InputStream stream, ContentHandler handler)
     ...
     */
    protected TFLyricsHandler(byte[] tagData)
            throws IOException, SAXException, TikaException {
        ...
        id3v1 = new TFID3v1Handler(last128);
