...
public interface TFID3Tags {
     ...
     */
    public static class TFID3Comment {
         ...
         */
        public TFID3Comment(String id3v1Text) {
           this.text = id3v1Text;
        }
        /**
         * Creates an ID3 v2 style comment tag
         */
        public TFID3Comment(String language, String description, String text) {
