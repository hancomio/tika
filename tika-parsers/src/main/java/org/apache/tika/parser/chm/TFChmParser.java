...
import org.apache.tika.parser.chm.core.TFChmExtractor;
...
public class TFChmParser extends AbstractParser {
    ...
    public void parse(InputStream stream, ContentHandler handler,
    	...
    	TFChmExtractor chmExtractor = new TFChmExtractor(stream);
