 ...
 */
public class TFID3v2Frame implements MP3Frame {
    ...
    public static MP3Frame createFrameIfPresent(InputStream inp)
        ...
        if (h1 == (int)'I' && h2 == (int)'D' && h3 == (int)'3') {
            ...
            return new TFID3v2Frame(majorVersion, minorVersion, inp);
        }
    ...
    private TFID3v2Frame(int majorVersion, int minorVersion, InputStream inp)
            throws IOException {
