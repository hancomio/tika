 ...
 */
public class TFMp3Parser extends AbstractParser {
    ...
    protected static ID3TagsAndAudio getAllTagHandlers(InputStream stream, ContentHandler handler)
       ...
       MP3Frame f;
       while ((f = TFID3v2Frame.createFrameIfPresent(mpegStream)) != null) {
           if(f instanceof TFID3v2Frame) {
               TFID3v2Frame id3F = (TFID3v2Frame)f;
               if (id3F.getMajorVersion() == 4) {
                   v24 = new TFID3v24Handler(id3F);
               } else if(id3F.getMajorVersion() == 3) {
                   v23 = new TFID3v23Handler(id3F);
               } else if(id3F.getMajorVersion() == 2) {
                   v22 = new TFID3v22Handler(id3F);
               }
           }
       }
