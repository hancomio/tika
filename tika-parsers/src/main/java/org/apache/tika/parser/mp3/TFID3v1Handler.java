 ...
 */
public class TFID3v1Handler implements TFID3Tags {
    private String title;
    private String artist;
    private String album;
    private String year;
    private TFID3Comment comment;
    private String genre;
    private String trackNumber;

    boolean found = false;

    public TFID3v1Handler(InputStream stream, ContentHandler handler)
     ...
     */
    protected TFID3v1Handler(byte[] tagData)
            throws IOException, SAXException, TikaException {
        if (tagData.length == 128
            ...
            comment = new TFID3Comment(commentStr);
